...
#define IDT_IDX_ISA_BASE 0x30
#define IDT_IDX_ISA_PIT (IDT_IDX_ISA_BASE + 0)
#define IDT_IDX_ISA_KB (IDT_IDX_ISA_BASE + 1)
#define IDT_IDX_ISA_COM1 (IDT_IDX_ISA_BASE + 4)
#define IDT_IDX_ISA_MOUSE (IDT_IDX_ISA_BASE + 12)
